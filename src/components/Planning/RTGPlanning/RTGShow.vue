    ...
    <v-data-table :headers="headers" :items="thisPlanningBoxes"
      ...
      <template v-slot:item="{ item, rowIndex }">
        <tr class="rowToEdit" :class="editMode ? 'clickableCase' : ''">
          <td width="15%"
          @click="item[0].checkedInBiggPlanning=!item[0].checkedInBiggPlanning"
          >
          ...
          @click="itemBox=clickOnThePlanningWorkBox(itemBox,index+2,rowIndex)"
          :class="[
           planningWorkBoxChecked && planningWorkBoxChecked_Index==(index+2)?'planningWorkBoxChecked':((planningWorkBoxChecked_Index!=-1)?'planningWorkBox_Not_Checked':'')
          ]"
          >
...
export default {
  ...
  methods: {
    ...
    clickOnThePlanningWorkBox(itemBox,index,rowIndex){
      ...
      if (!this.planningWorkBoxChecked) {
        ...
        itemBox.checkedInBiggPlanning = true;
         ...
         if (
          ...
          this.equipmentEditCheckedForSwitchWith = itemBox;
          itemBox.checkedInBiggPlanning = true;
        }
      } else if (
        this.planningWorkBoxChecked?.matricule == itemBox.matricule
